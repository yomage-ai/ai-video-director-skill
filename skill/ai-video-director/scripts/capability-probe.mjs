...
try {
  ...
  console.log(JSON.stringify({output,checks:checks.map(c=>c.name),note:'Editor, ASR and selected fine renderer require real host/tool evidence; creator review follows Agent preparation, without a listening-model prerequisite.'}));
