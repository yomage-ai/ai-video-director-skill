...
- Place the strip in a dedicated lower safe band that does not collide with captions, platform descriptions, action controls, evidence, or picture-in-picture. Check the densest card and longest caption together; adapt the band, label density, or geometry instead of covering useful content.
...
- Verify early, middle, late, and every chapter boundary in composed frames. Confirm duration-proportional widths, the correct active label, a monotonically advancing playhead, seek/re-render stability, phone-scale readability, and no safe-area collision.
