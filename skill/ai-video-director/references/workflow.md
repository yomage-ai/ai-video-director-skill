...
| 08 | Map each spoken section to evidence or a visual role; propose chapter labels, order, one-sentence scopes, and any recurring signature-outro candidate | LLM plus real artifacts | visual beat sheet and semantic chapter proposal |
