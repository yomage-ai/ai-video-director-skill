...
After sample approval, use [whole-program review](full-program-review.md) for the actual full-length states and final mix. 样片确认后按整片状态合同检查未出现在样片中的标题、卡片、录屏和声音组合。
